...
Example test_bin_incr1 : (incr (A (B Z))) = (B (B Z)).
Proof. reflexivity. Qed.

Example test_bin_incr2 : (incr (B (B Z))) = (A (A (B Z))).
Proof. reflexivity. Qed.

Example test_bin_to_nat1 : (bin_to_nat (A (B Z))) = 2.
Proof. reflexivity. Qed.

Example test_bin_to_nat2 : (bin_to_nat (B (B Z))) = 3.
Proof. reflexivity. Qed.
