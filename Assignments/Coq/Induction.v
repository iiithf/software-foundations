...
Proof.
  ...
  - simpl. rewrite -> IHn'. rewrite -> (plus_n_Sm m n'). reflexivity. Qed.
...
Proof.
  ...
  induction n as [|n' IHn'].
  - reflexivity.
  - simpl. rewrite <- (plus_n_Sm n' n'). rewrite -> IHn'. reflexivity. Qed.
(** [] *)
...
Proof.
  ...
  induction n as [| n' IHn'].
  - reflexivity.
  - rewrite -> IHn'. rewrite -> (negb_involutive (evenb n')). reflexivity. Qed.
(** [] *)
